...
public class ArmorsInit {
    ...
    public static void init(){
        ...
        TIMS_HELMET = new ArmorItemBase(McsaArmorMaterials.SHIELD_OF_INFINITY, EquipmentSlot.CHEST, new Item.Settings().group(Mcsa.ARMORS), "shield_of_infinity_chestplate");
        TIMS_CHESTPLATE = new ArmorItemBase(McsaArmorMaterials.SHIELD_OF_INFINITY, EquipmentSlot.CHEST, new Item.Settings().group(Mcsa.ARMORS), "shield_of_infinity_chestplate");
        TIMS_LEGGINGS = new ArmorItemBase(McsaArmorMaterials.SHIELD_OF_INFINITY, EquipmentSlot.LEGS, new Item.Settings().group(Mcsa.ARMORS), "shield_of_infinity_leggings");
        TIMS_BOOTS = new ArmorItemBase(McsaArmorMaterials.SHIELD_OF_INFINITY, EquipmentSlot.FEET, new Item.Settings().group(Mcsa.ARMORS), "shield_of_infinity_boots");
